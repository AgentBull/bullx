defmodule BullXAIAgent.Plugins.ModelRouting do
  @moduledoc """
  ...
  `BullXAIAgent.Agent` includes this plugin in its default runtime stack. To apply
  ...
  def schema do
    Zoi.object(%{
      routes:
        Zoi.map(description: "Signal type/pattern to model alias mapping")
        |> Zoi.default(@default_routes)
    })
  end
