require BullXAIAgent.Actions.Quota.GetStatus
require BullXAIAgent.Actions.Quota.Reset

defmodule BullXAIAgent.Plugins.Quota do
  @moduledoc """
  ...
  - `scope` - quota counter namespace in `BullXAIAgent.Quota.Store`
  ...
  use Jido.Plugin,
    ...
    state_key: :quota,
    actions: [
      BullXAIAgent.Actions.Quota.GetStatus,
      BullXAIAgent.Actions.Quota.Reset
    ],
  ...
  alias BullXAIAgent.Quota.Store
  ...
  def schema do
    Zoi.object(%{
      ...
      window_ms:
        Zoi.integer(description: "Rolling quota window in milliseconds") |> Zoi.default(60_000),
      max_requests:
      ...
      max_total_tokens:
        ...
        |> Zoi.optional(),
      error_message:
        Zoi.string(description: "User-facing quota rejection message")
        |> Zoi.default("quota exceeded")
    })
  end
  ...
  def signal_routes(_config) do
    [
      {"quota.status", BullXAIAgent.Actions.Quota.GetStatus},
      {"quota.reset", BullXAIAgent.Actions.Quota.Reset}
    ]
  end
