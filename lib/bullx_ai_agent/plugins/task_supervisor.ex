defmodule BullXAIAgent.Plugins.TaskSupervisor do
  @moduledoc """
  Plugin that creates and manages a per-instance Task.Supervisor for BullXAIAgent agents.
  ...
  This plugin is automatically added to BullXAIAgent agents to handle supervisor creation
  and cleanup.
  ...
  This plugin is automatically included when using `BullXAIAgent.Agent`. Manual
