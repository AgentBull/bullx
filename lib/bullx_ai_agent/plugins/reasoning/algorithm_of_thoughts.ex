...
defmodule BullXAIAgent.Plugins.Reasoning.AlgorithmOfThoughts do
  @moduledoc """
  Plugin capability for isolated Algorithm-of-Thoughts runs.

  ## Signal Contracts

  - `reasoning.aot.run` -> `BullXAIAgent.Actions.Reasoning.RunStrategy`
  ...
  `BullXAIAgent.Actions.Reasoning.RunStrategy` then consumes the normalized params
