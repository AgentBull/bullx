...
defmodule BullXAIAgent.Plugins.Reasoning.TreeOfThoughts do
  @moduledoc """
  Plugin capability for isolated Tree-of-Thoughts runs.

  ## Signal Contracts

  - `reasoning.tot.run` -> `BullXAIAgent.Actions.Reasoning.RunStrategy`
  ...
  Mount in an agent with fixed ToT defaults:
      ...
      plugins: [
        {BullXAIAgent.Plugins.Reasoning.TreeOfThoughts,
         %{
