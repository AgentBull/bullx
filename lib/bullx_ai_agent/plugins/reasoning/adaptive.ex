...
defmodule BullXAIAgent.Plugins.Reasoning.Adaptive do
  @moduledoc """
  Plugin capability for isolated Adaptive strategy runs.

  ## Signal Contracts

  - `reasoning.adaptive.run` -> `BullXAIAgent.Actions.Reasoning.RunStrategy`
  ...
  Mount in an agent with fixed Adaptive defaults:
      ...
      plugins: [
        {BullXAIAgent.Plugins.Reasoning.Adaptive,
         %{
