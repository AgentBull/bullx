require BullXAIAgent.Actions.Reasoning.RunStrategy

defmodule BullXAIAgent.Plugins.Reasoning.GraphOfThoughts do
  @moduledoc """
  Plugin capability for isolated Graph-of-Thoughts runs.

  ## Signal Contracts

  - `reasoning.got.run` -> `BullXAIAgent.Actions.Reasoning.RunStrategy`
  ...
  - `{:override, {BullXAIAgent.Actions.Reasoning.RunStrategy, params}}`
  - `params` always includes `strategy: :got` (caller strategy input is ignored)

  `BullXAIAgent.Actions.Reasoning.RunStrategy` consumes the normalized params
  ...
  Mount in an agent with fixed GoT defaults:
      ...
      plugins: [
        {BullXAIAgent.Plugins.Reasoning.GraphOfThoughts,
         %{
  ...
  use Jido.Plugin,
    ...
    actions: [BullXAIAgent.Actions.Reasoning.RunStrategy],
  ...
  def handle_signal(%Jido.Signal{type: "reasoning.got.run", data: data}, _context) do
    ...
    {:ok, {:override, {BullXAIAgent.Actions.Reasoning.RunStrategy, params}}}
  end
