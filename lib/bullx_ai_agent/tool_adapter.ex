defmodule BullXAIAgent.ToolAdapter do
  @moduledoc """
  ...
  ## Usage
      ...
      tools = BullXAIAgent.ToolAdapter.from_actions([
        MyApp.Actions.Calculator,
        MyApp.Actions.Search
      ])

      # With options
      tools = BullXAIAgent.ToolAdapter.from_actions(actions,
        prefix: "myapp_",
  ...
  actions to the LLM. Actual execution happens via `BullXAIAgent.Directive.ToolExec`.
  ...
  ## Examples
      ...
      # Basic usage
      tools = BullXAIAgent.ToolAdapter.from_actions([MyApp.Actions.Add, MyApp.Actions.Search])

      # With prefix
      tools = BullXAIAgent.ToolAdapter.from_actions(actions, prefix: "calc_")
  ...
  ## Example
      ...
      tool = BullXAIAgent.ToolAdapter.from_action(MyApp.Actions.Calculator, prefix: "v2_")
