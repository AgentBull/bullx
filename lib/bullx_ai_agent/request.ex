defmodule BullXAIAgent.Request do
  @moduledoc """
  ...
  defmodule MyAgent do
    ...
    def await(request, opts \\\\ []) do
      BullXAIAgent.Request.await(request, opts)
    end
  end
  ```
  """
  ...
  def start_request(agent, request_id, query, opts \\ [])
      when is_binary(request_id) and is_binary(query) do
    stream_to = Keyword.get(opts, :stream_to)
  ...
  ## Example
      ...
      base_schema_ast = quote do
        Zoi.object(Map.merge(
          ...
          BullXAIAgent.Request.schema_fields()
        ))
      end
  """
