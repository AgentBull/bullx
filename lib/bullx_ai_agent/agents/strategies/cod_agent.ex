...
defmodule BullXAIAgent.CoDAgent do
  @moduledoc """
  Base macro for Chain-of-Draft-powered agents.

  Wraps `use Jido.Agent` with `BullXAIAgent.Reasoning.ChainOfDraft.Strategy` wired in,
  ...
  defmacro __using__(opts) do
    ...
    default_system_prompt = BullXAIAgent.Reasoning.ChainOfDraft.default_system_prompt()
    ...
    quote location: :keep do
      use Jido.Agent,
        ...
        strategy: {BullXAIAgent.Reasoning.ChainOfDraft.Strategy, unquote(strategy_opts_ast)},
      ...
      def on_before_cmd(
            agent,
            {:cod_request_error, %{request_id: request_id, reason: reason, message: message}} =
              action
          ) do
