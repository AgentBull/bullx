...
defmodule BullXAIAgent.AoTAgent do
  @moduledoc """
  Base macro for Algorithm-of-Thoughts-powered agents.

  Wraps `use Jido.Agent` with `BullXAIAgent.Reasoning.AlgorithmOfThoughts.Strategy`
  ...
  defmacro __using__(opts) do
    ...
    quote location: :keep do
      ...
      def on_before_cmd(
            agent,
            {:aot_request_error, %{request_id: request_id, reason: reason, message: message}} =
              action
          ) do
