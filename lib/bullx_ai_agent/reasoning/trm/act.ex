defmodule BullXAIAgent.Reasoning.TRM.ACT do
  @moduledoc """
  Adaptive Computational Time (ACT) module for TRM strategy.

  Uses `BullXAIAgent.Reasoning.TRM.Helpers.clamp/3` for value clamping.
  ...
  import BullXAIAgent.Reasoning.TRM.Helpers, only: [clamp: 3]
