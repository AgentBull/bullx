defmodule BullXAIAgent.Reasoning.ReAct.CLIAdapter do
  @moduledoc """
  CLI adapter for `BullXAIAgent.Agent` modules (ReAct strategy implied).
  ...
  def create_ephemeral_agent(config) do
    ...
    module_name = Module.concat([BullXAIAgent, EphemeralAgent, :"ReAct#{suffix}"])
