defmodule BullXAIAgent.Reasoning.ReAct.Runner do
  @moduledoc """
  ...
  alias BullXAIAgent.Reasoning.ReAct.{Config, Event, PendingToolCall, State, Token, ToolSelection}
  ...
  defp visible_chunk?(%ReqLLM.StreamChunk{type: :thinking, text: text}, trace_cfg),
    do: delta_captured?(text, trace_cfg)
