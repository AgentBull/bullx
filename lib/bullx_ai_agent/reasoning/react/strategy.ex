defmodule BullXAIAgent.Reasoning.ReAct.Strategy do
  @moduledoc """
  ...
  4. Worker streams `BullXAIAgent.Reasoning.ReAct` events and emits `"ai.react.worker.event"` to parent.
  ...
  alias BullXAIAgent.Reasoning.ReAct.PendingInput
  alias BullXAIAgent.Reasoning.ReAct.RequestTransformer
  alias BullXAIAgent.Reasoning.ReAct.State, as: ReActState
  alias BullXAIAgent.Reasoning.ReAct.Config, as: ReActRuntimeConfig
  alias BullXAIAgent.Reasoning.ReAct.ToolSelection
  ...
  defp ensure_worker_start(state, worker_start_payload) do
    if is_pid(state[:react_worker_pid]) and Process.alive?(state[:react_worker_pid]) do
      ...
      spawn_directive =
        AgentDirective.spawn_agent(BullXAIAgent.Reasoning.ReAct.Worker.Agent, @worker_tag)
  ...
  defp build_config(agent, ctx) do
    ...
    tools_modules =
      case Keyword.fetch(opts, :tools) do
        ...
        :error ->
          raise ArgumentError,
                "BullXAIAgent.Reasoning.ReAct.Strategy requires :tools option (list of Jido.Action modules)"
      end
