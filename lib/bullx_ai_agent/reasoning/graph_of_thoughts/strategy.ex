defmodule BullXAIAgent.Reasoning.GraphOfThoughts.Strategy do
  @moduledoc """
  ...
  This strategy uses a pure state machine (`BullXAIAgent.Reasoning.GraphOfThoughts.Machine`) for
  ...
  Configure via strategy options when defining your agent:
      ...
      use Jido.Agent,
        name: "my_got_agent",
        strategy: {
          BullXAIAgent.Reasoning.GraphOfThoughts.Strategy,
  ...
  alias BullXAIAgent.Reasoning.GraphOfThoughts.Machine
    ...
    %{
      ...
      aggregation_strategy:
        Map.get(
          agent.state,
          :aggregation_strategy,
          Keyword.get(opts, :aggregation_strategy, :synthesis)
        ),
      generation_prompt:
        Map.get(
          agent.state,
