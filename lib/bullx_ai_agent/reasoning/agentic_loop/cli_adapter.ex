defmodule BullXAIAgent.Reasoning.AgenticLoop.CLIAdapter do
  @moduledoc """
  CLI adapter for `BullXAIAgent.Agent` modules (AgenticLoop strategy implied).
  ...
  def create_ephemeral_agent(config) do
    ...
    module_name = Module.concat([BullXAIAgent, EphemeralAgent, :"AgenticLoop#{suffix}"])
