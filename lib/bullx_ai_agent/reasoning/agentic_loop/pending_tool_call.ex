defmodule BullXAIAgent.Reasoning.AgenticLoop.PendingToolCall do
  @moduledoc """
  Tracks a tool call in the AgenticLoop runtime.
  """
  ...
  @schema Zoi.struct(
            ...
            %{
              ...
              duration_ms:
                Zoi.integer(description: "Execution duration in milliseconds") |> Zoi.optional()
            },
            coerce: true
          )
  ...
  """
  @spec complete(t(), {:ok, term()} | {:error, term()}, non_neg_integer(), non_neg_integer()) ::
          t()
