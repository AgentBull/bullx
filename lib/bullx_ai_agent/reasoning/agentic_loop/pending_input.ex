defmodule BullXAIAgent.Reasoning.AgenticLoop.PendingInput do
  @moduledoc """
  Pending-input helpers for delegated AgenticLoop runs.

  This module keeps the acceptance rules and queue lifecycle for `steer` and
  `inject` control input out of the main AgenticLoop strategy so the public
