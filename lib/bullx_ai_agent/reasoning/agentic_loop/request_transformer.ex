defmodule BullXAIAgent.Reasoning.AgenticLoop.RequestTransformer do
  @moduledoc """
  Behavior for advanced per-turn AgenticLoop request shaping.
  ...
  alias BullXAIAgent.Reasoning.AgenticLoop.{Config, State, ToolSelection}
  ...
  @doc """
  Fingerprint a validated transformer for runtime event metadata.
  """
