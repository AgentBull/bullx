defmodule BullXAIAgent.Reasoning.ChainOfDraft.Strategy do
  @moduledoc """
  ...
  alias BullXAIAgent.Reasoning.ChainOfDraft
  ...
  def init(agent, ctx) do
    ...
    strategy_opts =
      Keyword.put_new(strategy_opts, :system_prompt, ChainOfDraft.default_system_prompt())
  ...
  """
  @spec get_steps(Jido.Agent.t()) :: [BullXAIAgent.Reasoning.ChainOfThought.Machine.step()]
