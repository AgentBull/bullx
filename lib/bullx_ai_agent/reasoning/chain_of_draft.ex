defmodule BullXAIAgent.Reasoning.ChainOfDraft do
  @moduledoc """
  ...
  `BullXAIAgent.Reasoning.ChainOfDraft.Strategy`.
  """

  alias BullXAIAgent.Reasoning.ChainOfDraft.Strategy
  alias BullXAIAgent.Reasoning.ChainOfThought
  ...
  @spec extract_steps_and_conclusion(term()) ::
          {[BullXAIAgent.Reasoning.ChainOfThought.Machine.step()], String.t() | nil}
