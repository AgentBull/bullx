defmodule BullXAIAgent.Reasoning.AlgorithmOfThoughts.Strategy do
  @moduledoc """
  ...
  defp apply_machine_update(agent, {:llm_result, call_id, _result}, _config)
       when not is_binary(call_id),
       do: {agent, []}
  ...
  defp merge_runtime_state(new_state, previous_state, {:start, _prompt, request_id}),
    do:
      RequestLifecycle.put_active_request_id(previous_state, new_state, request_id, [:exploring])
