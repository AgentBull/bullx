defmodule BullXAIAgent.Reasoning.AlgorithmOfThoughts.CLIAdapter do
  @moduledoc """
  ...
  def create_ephemeral_agent(config) do
    ...
    module_name = Module.concat([BullXAIAgent, EphemeralAgent, :"AoT#{suffix}"])
