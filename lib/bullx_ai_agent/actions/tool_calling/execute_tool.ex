defmodule BullXAIAgent.Actions.ToolCalling.ExecuteTool do
  @moduledoc """
  ...
  It uses `BullXAIAgent.Turn` tool execution to keep result formatting consistent.
  ...
  * `timeout` (optional) - Execution timeout in milliseconds (default: `30000`)
  ...
  ## Examples
      ...
      {:ok, result} = Jido.Exec.run(BullXAIAgent.Actions.ToolCalling.ExecuteTool, %{
