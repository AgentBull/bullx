defmodule BullXAIAgent.Actions.Helpers do
  @moduledoc """
  Shared helper functions for BullXAIAgent skill actions.
  ...
  * `validate_and_sanitize_input/2` - Validate input with security checks
  ...
  ## Examples
      ...
      use BullXAIAgent.Actions.Helpers
  ...
  alias BullXAIAgent.Error.Sanitize
  ...
  * `params` - Map containing :max_tokens, :temperature, :timeout keys
  ...
  Delegates to `BullXAIAgent.Turn.extract_text/1` which handles
  ...
  * `{:error, reason}` - Validation failed
  ...
  Uses `BullXAIAgent.Error.Sanitize.sanitize_error_message/1` to convert
