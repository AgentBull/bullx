defmodule BullXAIAgent.Actions.Reasoning.Explain do
  @moduledoc """
  ...
  * `timeout` (optional) - Request timeout in milliseconds
  ...
  ## Examples
      ...
      # Basic explanation
      {:ok, result} = Jido.Exec.run(BullXAIAgent.Actions.Reasoning.Explain, %{
        topic: "Recursion",
        detail_level: :basic
      })
  ...
  * `{:error, reason}` - Error from ReqLLM or validation
  ...
  defp build_explanation_messages(params) do
    system_prompt =
      build_explanation_system_prompt(params[:detail_level], params[:include_examples])
