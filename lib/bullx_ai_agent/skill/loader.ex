defmodule BullXAIAgent.Skill.Loader do
  @moduledoc """
  Parses SKILL.md files into `BullXAIAgent.Skill.Spec` structs.

  Supports the agentskills.io format with YAML frontmatter.
  """

  alias BullXAIAgent.Skill.{Spec, Error}
