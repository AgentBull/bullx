defmodule BullXAIAgent.Error do
  @moduledoc """
  Splode-based error handling for BullXAIAgent.
  ...
  use Splode,
    error_classes: [
      api: BullXAIAgent.Error.API,
      validation: BullXAIAgent.Error.Validation
    ],
    unknown_error: BullXAIAgent.Error.Unknown
end

defmodule BullXAIAgent.Error.API do
...
defmodule BullXAIAgent.Error.Validation do
...
defmodule BullXAIAgent.Error.Unknown do
...
defmodule BullXAIAgent.Error.API.RateLimit do
...
defmodule BullXAIAgent.Error.API.Auth do
...
defmodule BullXAIAgent.Error.API.Request do
  @moduledoc """
...
defmodule BullXAIAgent.Error.Validation.Invalid do
