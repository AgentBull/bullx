defmodule BullXAIAgent.Directive.LLMStream do
  @moduledoc """
  ...
  - `model_alias` - Model alias (e.g., `:fast`) resolved via `BullXAIAgent.resolve_model/1`
  ...
  @schema Zoi.struct(
            ...
            %{
              ...
              context:
                Zoi.any(
                  description: "Conversation context: [ReqLLM.Message.t()] or ReqLLM.Context.t()"
                ),
              tools:
                Zoi.list(Zoi.any(),
...
defimpl Jido.AgentServer.DirectiveExec, for: BullXAIAgent.Directive.LLMStream do
  @moduledoc """
  ...
  Supports:
  - `model_alias` resolution via `BullXAIAgent.resolve_model/1`
  ...
  `state[:task_supervisor]`. The supervisor is started automatically by BullXAIAgent
  when an agent is created.
  """

  alias BullXAIAgent.{Observe, Signal, Turn}
  alias BullXAIAgent.Directive.Helpers
               ...
               e ->
                 {:error,
                  %{
                    ...
                    type: e.__struct__,
                    error_type: Helpers.classify_error(e)
                  }}
             catch
               kind, reason ->
