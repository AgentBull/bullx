defmodule BullXAIAgent.Directive.EmitToolError do
  @moduledoc """
...
defimpl Jido.AgentServer.DirectiveExec, for: BullXAIAgent.Directive.EmitToolError do
  @moduledoc """
  ...
  def exec(directive, _input_signal, state) do
    ...
    signal =
      Signal.ToolResult.new!(%{
        ...
        result:
          {:error,
           SignalHelpers.normalize_error(error, :execution_error, "Tool execution failed", %{
             tool_name: tool_name
           }), []},
        metadata: metadata
      })
