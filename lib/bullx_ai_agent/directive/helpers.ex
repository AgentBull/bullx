defmodule BullXAIAgent.Directive.Helpers do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> BullXAIAgent.Directive.Helpers.get_task_supervisor(state)
      supervisor_pid
      ...
      _ ->
        ...
        case Map.get(state, :task_supervisor) do
          nil ->
            ...
            Ensure your agent is started with BullXAIAgent which will automatically
  ...
  def classify_error(%{reason: reason}) when reason in [:econnrefused, :nxdomain, :closed],
    do: :network
