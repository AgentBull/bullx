defmodule BullXAIAgent.Quality.Checkpoint do
  @moduledoc """
  ...
  def full_gate_commands do
    [
      %{
        gate: :full,
        label: "mix test --exclude flaky",
        cmd: "mix",
        args: ["test", "--exclude", "flaky"]
      },
  ...
  """
  @spec run_commands([command_spec()], keyword()) ::
  ...
  """
  @spec run_command(command_spec(), keyword()) ::
          {:ok, command_timing()} | {:error, command_failure()}
