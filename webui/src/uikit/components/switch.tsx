...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "peer group/switch relative inline-flex shrink-0 items-center rounded-full border border-transparent transition-colors outline-none after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:ring-2 focus-visible:ring-ring/30 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 data-[size=default]:h-6 data-[size=default]:w-12 data-[size=default]:[--switch-thumb:1.125rem] data-[size=default]:[--switch-x:1.6875rem] data-[size=sm]:h-4 data-[size=sm]:w-8 data-[size=sm]:[--switch-thumb:0.625rem] data-[size=sm]:[--switch-x:1.1875rem] dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 data-checked:bg-success data-unchecked:bg-gray-50 data-disabled:cursor-not-allowed data-disabled:opacity-50 dark:data-unchecked:bg-gray-60",
        className
      )}
      {...props}
    >
